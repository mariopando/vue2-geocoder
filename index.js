export default {
    install(Vue, options) {
        ...
        Vue.$placeDetails = Vue.prototype.$placeDetails = {
            defaultLanguage: null,
            googleMapsApiKey:   options.googleMapsApiKey,
            ...
            send(dataObj, callback = null) {
                this.getGooglePlacesResponse(dataObj, callback);
            },

            getGooglePlacesResponse(locationObj, callback = null) {
                var placeId  = locationObj.placeId;
                var fields  = locationObj.fields.join(',');
                var url = this.getDefaultUrl();
